...
library(readxl)
library(plyr)
natural_resources = read_excel("circle2016/prep/NP/data/Natural_resources_data.xlsx", sheet = 1, col_names = TRUE, col_types = NULL, na = "", skip = 0)
...
narwhal = read_excel("circle2016/prep/NP/data//marine_mammals.xlsx", sheet = 1, col_names = TRUE, col_types = NULL, na = "", skip = 0)
...
natural_resources<-plyr::rename(natural_resources, c("totalcatch"="value", "Country"="rgn_id"))
